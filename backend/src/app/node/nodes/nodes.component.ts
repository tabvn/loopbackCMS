...
export class NodesComponent implements OnInit, OnDestroy {
	...
	constructor(private realtime: RealtimeService, private route: ActivatedRoute,
	...
	onNodeCreate(): void {
		...
		this.realtime.subscribe(subsribeOption).subscribe((response: any) => {
			console.log("We got data from socket with object: ", response);
